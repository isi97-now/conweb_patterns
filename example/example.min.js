...
dragula([$('left-copy-1tomany'), $('right-copy-1tomany')], {
  ...
  // variabile a
  var a=$('right-copy-1tomany');
  var c=$('ok');
  var element = document.getElementById("check_2");
  var r=$('message');
  var array=[];
  for (let i = 0; i < a.children.length; i++) {
  console.log(a.children[i].id);
  array.push(a.children[i].id);
  }
  if (array.length==["w1","w2","w3","w4","w5","w6","w7"].length){
    if( arrayEquals(array,["w1","w2","w3","w4","w5","w6","w7"])){ console.log("true");
  a.setAttribute("style",a.style= "border: solid #57B571");

  document.getElementById("demo").innerHTML = 'Yay! You did it! Everything is in the exact order!';
  ...
  message.classList.add("green_message");
    ...
    a.setAttribute("style",a.style= "border: solid #AE5B77");

    document.getElementById("demo").innerHTML = 'The conversation seems unordered, try again!';
