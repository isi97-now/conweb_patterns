...
dragula([$('left-copy-1tomany'), $('right-copy-1tomany')], {
  ...
  b.setAttribute("style",b.style= "color: #57B571");

}else{
    a.setAttribute("style",a.style= "border: solid #AE5B77");
    b.setAttribute("style",b.style= "background-color: red");
    b.setAttribute("style",b.style= "color: #AE5B77");

};
}else{
  a.setAttribute("style",a.style= "");
  b.setAttribute("style",b.style= "");
};
