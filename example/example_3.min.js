(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-3tomany'), $('right-copy-3tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-3tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-3tomany');
      var element = document.getElementById("check_4");
      var message = $('message_3');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8"].length) {
        if (arrayEquals(array, ["f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_3").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_3").innerHTML = 'The conversation seems unordered, try again!';
