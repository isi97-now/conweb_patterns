(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-14tomany'), $('right-copy-14tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-14tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-14tomany');
      var element = document.getElementById("check_14");
      var message = $('message_20');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["u1", "u2", "u3", "u4", "u5", "u6", "u7", "u8", "u9"].length) {
        if (arrayEquals(array, ["u1", "u2", "u3", "u4", "u5", "u6", "u7", "u8", "u9"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_14").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_14").innerHTML = 'The conversation seems unordered, try again!';
