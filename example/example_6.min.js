(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-6tomany'), $('right-copy-6tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-6tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-6tomany');
      var element = document.getElementById("check_7");
      var message = $('message_6');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8"].length) {
        if (arrayEquals(array, ["p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_6").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_6").innerHTML = 'The conversation seems unordered, try again!';
