(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-8tomany'), $('right-copy-8tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-8tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-8tomany');
      var element = document.getElementById("check_9");
      var message = $('message_8');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["k1", "k2", "k3", "k4", "k5", "k6", "k7", "k8"].length) {
        if (arrayEquals(array, ["k1", "k2", "k3", "k4", "k5", "k6", "k7", "k8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_9").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_9").innerHTML = 'The conversation seems unordered, try again!';
