...
dragula([$('left-copy-2tomany'), $('right-copy-2tomany')], {
  ...
  if (array.length==["s1","s2","s3","s4","s5","s6","s7"].length){
    if( arrayEquals(array,["s1","s2","s3","s4","s5","s6","s7"])){ console.log("true");
  c.setAttribute("style",c.style= "border: solid #57B571");
  d.setAttribute("style",d.style= "color: #57B571");

}else{
    c.setAttribute("style",c.style= "border: solid #AE5B77");
    d.setAttribute("style",d.style= "background-color: red");
    d.setAttribute("style",d.style= "color: #AE5B77");

};
}else{
  c.setAttribute("style",c.style= "");
  d.setAttribute("style",d.style= "");
};
