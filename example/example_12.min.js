(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-13tomany'), $('right-copy-13tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-13tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-13tomany');
      var element = document.getElementById("check_13");
      ...
      if (array.length == ["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8"].length) {
        if (arrayEquals(array, ["v1", "v2", "v3", "v4", "v5", "v6", "v7", "v8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_13").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_13").innerHTML = 'The conversation seems unordered, try again!';
