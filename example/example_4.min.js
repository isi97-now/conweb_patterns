(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-4tomany'), $('right-copy-4tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-4tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-4tomany');
      var element = document.getElementById("check_5");
      var message = $('message_4');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["l1", "l2", "l3", "l4", "l5", "l6", "l7", "l8"].length) {
        if (arrayEquals(array, ["l1", "l2", "l3", "l4", "l5", "l6", "l7", "l8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_4").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_4").innerHTML = 'The conversation seems unordered, try again!';
