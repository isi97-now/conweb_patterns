(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-5tomany'), $('right-copy-5tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-5tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-5tomany');
      var element = document.getElementById("check_6");
      var message = $('message_5');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["i1", "i2", "i3", "i4", "i5", "i6", "i7"].length) {
        if (arrayEquals(array, ["i1", "i2", "i3", "i4", "i5", "i6", "i7"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_5").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_5").innerHTML = 'The conversation seems unordered, try again!';
