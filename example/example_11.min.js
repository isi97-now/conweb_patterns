(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-11tomany'), $('right-copy-11tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-11tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-11tomany');
      var element = document.getElementById("check_12");
      var message = $('message_11');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["q1", "q2", "q3", "q4", "q5", "q6", "q7", "q8"].length) {
        if (arrayEquals(array, ["q1", "q2", "q3", "q4", "q5", "q6", "q7", "q8"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_12").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_12").innerHTML = 'The conversation seems unordered, try again!';
