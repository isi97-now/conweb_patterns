(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-9tomany'), $('right-copy-9tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-9tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-9tomany');
      var element = document.getElementById("check_10");
      var message = $('message_9');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["z1", "z2", "z3", "z4", "z5", "z6", "z7", "z8", "z9"].length) {
        if (arrayEquals(array, ["z1", "z2", "z3", "z4", "z5", "z6", "z7", "z8", "z9"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_10").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_10").innerHTML = 'The conversation seems unordered, try again!';
