(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    dragula([$('left-copy-10tomany'), $('right-copy-10tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-10tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-10tomany');
      var element = document.getElementById("check_11");
      var message = $('message_10');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["x1", "x2", "x3", "x4", "x5", "x6", "x7", "x8", "x9"].length) {
        if (arrayEquals(array, ["x1", "x2", "x3", "x4", "x5", "x6", "x7", "x8", "x9"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_11").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          ...
          document.getElementById("demo_11").innerHTML = 'The conversation seems unordered, try again!';
