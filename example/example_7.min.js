(function e(t, n, r) {
  ...
  1: [function(require, module, exports) {
    ...
    function arrayEquals(c, d) {
      return Array.isArray(c) &&
        Array.isArray(c) &&
        c.length === d.length &&
        c.every((val, index) => val === d[index]);
    }
    ...
    dragula([$('left-copy-7tomany'), $('right-copy-7tomany')], {
      accepts: function(el, target) {
        return target !== $('left-copy-7tomany');
      },
    }).on('drop', function(el) {
      el.firstElementChild.setAttribute("style", "display:none;");
      el.lastElementChild.setAttribute("style", "display:flex;");
      // variabile a
      var c = $('right-copy-7tomany');
      var element = document.getElementById("check_8");
      var message = $('message_7');
      var gift = $('gift');
      var array = [];
      for (let i = 0; i < c.children.length; i++) {
        console.log(c.children[i].id);
        array.push(c.children[i].id);
      }
      if (array.length == ["o1", "o2", "o3", "o4", "o5", "o6", "o7", "o8", "o9"].length) {
        if (arrayEquals(array, ["o1", "o2", "o3", "o4", "o5", "o6", "o7", "o8", "o9"])) {
          console.log("true");
          c.setAttribute("style", c.style = "border: solid #57B571");

          document.getElementById("demo_8").innerHTML = 'Yay! You did it! Everything is in the exact order!';
          element.classList.add("uil-comment-check");
          element.classList.remove("uil-comment-dots");
          element.classList.remove("uil-comment-block");

          message.setAttribute("style", "color:#57B571;");
          message.classList.remove("red_message");
          message.classList.add("green_message");



        } else {
          c.setAttribute("style", c.style = "border: solid #AE5B77");

          document.getElementById("demo_8").innerHTML = 'The conversation seems unordered, try again!';
          element.classList.add("uil-comment-block");
          element.classList.remove("uil-comment-dots");
          element.classList.remove("uil-comment-check");

          message.setAttribute("style", "color:#AE5B77;");
          message.classList.add("red_message");
          message.classList.remove("green_message");

          gift.setAttribute("style", "visibility:visible;");


        };
      } else {
        c.setAttribute("style", c.style = "");
      };
